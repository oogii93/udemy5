        ...
        <div class="mv-4 grid grid-cols-2 gap-4">
            <div>
                ...
                <x-text-input name="search" value="{{ request('search') }}"
                 place="Search for any text" form-ref="filters"></x-text-input>
            </div>
            <div>
                <div class="mb-1 font-semibold">Salary</div>
                <div class="flex space-x-2">
                <x-text-input name="min_salary" value="{{ request('min_salary') }}" place="From" form-ref="filters"></x-text-input>
                <x-text-input name="max_salary" value="{{ request('max_salary') }}" place="To"  form-ref="filters"></x-text-input>
